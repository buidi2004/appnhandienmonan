  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={[styles.header, { backgroundColor: colors.card, borderBottomWidth: 1, borderBottomColor: colors.border }]}>
        <Text style={[typography.h2, { color: colors.text }]}>Điều khoản & Pháp lý</Text>
        <Text style={[typography.body, { color: colors.textSecondary, marginTop: 4, fontSize: 13 }]}>Vui lòng đọc kỹ trước khi sử dụng ứng dụng.</Text>
      </View>
      ...
      >
        <Text style={[styles.sectionTitle, { color: colors.text }]}>1. Thu thập và Xử lý dữ liệu</Text>
        ...
        <Text style={[styles.sectionTitle, { color: colors.text }]}>2. Trách nhiệm người dùng</Text>
        <Text style={[styles.sectionText, { color: colors.textSecondary }]}>
        ...
        <Text style={[styles.sectionTitle, { color: colors.text }]}>3. Miễn trừ trách nhiệm Y tế</Text>
        <Text style={[styles.sectionText, { color: colors.textSecondary }]}>
        ...
        <Text style={[styles.sectionTitle, { color: colors.text }]}>4. Sở hữu trí tuệ</Text>
        <Text style={[styles.sectionText, { color: colors.textSecondary }]}>
        ...
        <Text style={[styles.sectionTitle, { color: colors.text }]}>5. Thay đổi điều khoản</Text>
      ...
      <View style={[styles.footer, { backgroundColor: colors.card, padding: 20, borderTopWidth: 1, borderTopColor: colors.border }]}>
        <TouchableOpacity 
        ...
        >
          ...
          <Text style={[typography.body, { color: hasScrolledToBottom ? colors.text : colors.textSecondary, flex: 1, fontSize: 14 }]}>
        ...
        <TouchableOpacity 
          style={[
            styles.btn, 
            { 
              backgroundColor: (agreed && hasScrolledToBottom) ? colors.primary : colors.border, 
              borderRadius: 14, 
              marginTop: 16 
            }
          ]}
        ...
        >
          <Text style={[typography.h3, { color: (agreed && hasScrolledToBottom) ? '#FFF' : colors.textSecondary }]}>Đồng ý và Tiếp tục</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
